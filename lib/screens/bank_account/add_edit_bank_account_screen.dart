  ...
  Future<void> _save() async {
    ...
    try {
      final bank = BankAccountModel(
        ...
        accountHolderName: _accountHolderName.text.trim().toUpperCase(), // Tên thường viết hoa
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              widget.bank == null ? 'Bank account added' : 'Bank account updated',
            ),
          ),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GestureDetector(
        onTap: () => FocusScope.of(context).unfocus(), // Chạm ra ngoài để tắt bàn phím
