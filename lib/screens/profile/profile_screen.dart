...
class ProfileScreen extends StatelessWidget {
          ...
          Expanded(
            child: Container(
              transform: Matrix4.translationValues(
                  0, -20, 0), // Tạo hiệu ứng đè nhẹ lên header
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(fullName,
                    style: AppTextStyle.whiteTitle.copyWith(fontSize: 20)),
    ...
    return Column(
      ...
      children: [
        ...
        _buildMenuTile(
            ...
            () => Get.to(() => MyShippingAddressScreen())),
        _buildMenuTile(
            Icons.shopping_bag_rounded,
            'Giỏ hàng của tôi',
            'Xem các mặt hàng đã chọn',
            () => Get.toNamed(AppRoutes.cartOverview)),
        _buildMenuTile(
  ...
  Widget _buildAppSettingLabel() =>
      Text('Cài đặt ứng dụng', style: AppTextStyle.title);
    ...
    return Obx(() => Column(
          children: [
            _buildMenuTile(
                ...
                'Giao diện',
                'Chế độ: ${controller.themeMode.value.name.capitalizeFirst}',
                () => _showThemeDialog(controller)),
            _buildMenuTile(
                Icons.text_fields_rounded,
                'Cỡ chữ',
                'Hiện tại: ${controller.fontSize.value.capitalizeFirst}',
                () => _showFontDialog(controller)),
            _buildMenuTile(
                Icons.language_rounded,
                'Ngôn ngữ',
                'Ngôn ngữ: ${controller.locale.value.languageCode.toUpperCase()}',
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 20),
                const Text('Chào mừng khách!',
                    style: TextStyle(
                        fontSize: 22,
                        fontWeight: FontWeight.bold,
                        color: Colors.white)),
                const SizedBox(height: 8),
                const Text('Đăng nhập để trải nghiệm đầy đủ tính năng',
